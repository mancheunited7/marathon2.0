class CompetitionResultsController < ApplicationController
  ...
  def competition_result_params
    params.require(:competition_result).permit(:user_id, :day, :competition_name, :address, :competition_place, :latitude, :longitude, :weather, :temperature, :humidity, :wind_speed, :distance, :hour, :minute, :second, :calctime, :heart_rate, :weight, :body_fat, :content, :competition_result_photo, :competition_result_photo_cache, :competition_point, :competition_memo)
  end
end
